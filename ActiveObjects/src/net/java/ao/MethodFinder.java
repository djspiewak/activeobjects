...
final class MethodFinder {
	...
	public Method[] findAnnotation(Class<? extends Annotation> annotation, Class<? extends Entity> clazz) {
	...
	private static final class CacheKey {
		...
		public CacheKey(Class<? extends Annotation> annotation, Class<? extends Entity> type) {
